...
{
   // Point to the colleague for communication with the mediator
   pBulletColleague = new BulletColleague(this);
 ...
 * BULLET constructor
 *********************************************/
Bullet::Bullet(Mediator* pMediator, double angle, double speed, double radius, int value) :
   dead(false), radius(radius), value(value)
{
   // Point to the colleague for communication with the mediator
   pBulletColleague = new BulletColleague(this, pMediator);
